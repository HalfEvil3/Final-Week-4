...
<?php $sql = "SELECT * FROM LOLStatistics..ChampStats"; 
	...
	<div class="row">
	  ...
	  <div class="medium-4 columns">
			...
			<ul style="list-style-type:none" class="text-center stats">
			  <li><?php $winrate = sqlsrv_get_field( $stmt, 6); echo "Win Rate:" . $winrate; ?></li>
			  <li><?php $playrate = sqlsrv_get_field( $stmt, 7); echo "Play Rate:" . $playrate; ?></li>
			  <li><?php $banrate = sqlsrv_get_field( $stmt, 8); echo "Ban Rate:" . $banrate; ?></li>
			  <li><?php $avggold = sqlsrv_get_field( $stmt, 9); echo "Gold Earned:" . $avggold; ?></li>
			  <li><?php $kills = sqlsrv_get_field( $stmt, 10); echo "Kills:" . $kills; ?></li>
			  <li><?php $deaths = sqlsrv_get_field( $stmt, 11); echo "Deaths:" . $deaths; ?></li>
			  <li><?php $assist = sqlsrv_get_field( $stmt, 12); echo "Assists:" . $assist; ?></li>
			</ul>
	  </div>
	</div>
